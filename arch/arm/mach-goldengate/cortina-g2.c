...
static struct resource cs75xx_uart0_resources[] = {
	[0] = {
		.start	= IO_ADDRESS(UART0_BASE_ADDR),
		.end	= IO_ADDRESS(UART0_BASE_ADDR) + 0x30 - 1,
		.flags	= IORESOURCE_MEM,
	},
	[1] = {
...
static struct resource cs75xx_uart1_resources[] = {
	[0] = {
		.start	= IO_ADDRESS(UART1_BASE_ADDR),
		.end	= IO_ADDRESS(UART1_BASE_ADDR) + 0x30 - 1,
		.flags	= IORESOURCE_MEM,
	},
	[1] = {
...
static struct resource cs75xx_uart2_resources[] = {
	[0] = {
		.start	= IO_ADDRESS(UART2_BASE_ADDR),
		.end	= IO_ADDRESS(UART2_BASE_ADDR) + 0x30 - 1,
		.flags	= IORESOURCE_MEM,
	},
	[1] = {
...
static struct resource cs75xx_uart3_resources[] = {
	[0] = {
		.start	= IO_ADDRESS(UART3_BASE_ADDR),
		.end	= IO_ADDRESS(UART3_BASE_ADDR) + 0x30 - 1,
		.flags	= IORESOURCE_MEM,
	},
	[1] = {
