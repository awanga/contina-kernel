...
#define IO_ADDRESS(x)		(volatile void __iomem *)( (((x) & 0xF0000000) == 0xF0000000) ? \
								(x) : (((x)&0xFF000000)>>8 |0xFE000000| ((x)&0x0000FFFF)) )

#else
#define IO_ADDRESS(x)		((volatile void __iomem *)x)
#endif
#define __io_address(n)		__io((long unsigned int)IO_ADDRESS(n))
